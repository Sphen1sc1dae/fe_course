...
FROM
    ...
    customer c ON oh.customer_id = c.customer_id
        INNER JOIN
    employee e ON oh.employee_id = e.employee_id
WHERE
...
FROM
    order_detail od,
    product p, order_header oh, customer c
WHERE
    od.product_id = p.product_id and oh.order_id = od.order_id and oh.customer_id = c.customer_id and order_qty >= 30;
